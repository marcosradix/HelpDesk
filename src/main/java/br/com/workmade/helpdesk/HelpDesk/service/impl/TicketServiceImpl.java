...
import br.com.workmade.helpdesk.HelpDesk.repository.ChangeStatusRepository;
import br.com.workmade.helpdesk.HelpDesk.repository.TicketRepository;
...
public class TicketServiceImpl implements TicketService {
	...
	public Page<Ticket> findByParameters(int page, int count, String titulo, String status, String priority) {
		Pageable pages = new PageRequest(page, count);
		return this.ticketRepository.findByTituloIgnoreCaseContainingAndStatusAndPriorityOrderByDateDesc(titulo, status, priority, pages);
	}
	...
	public Page<Ticket> findByParametersAndCurrentUser(int page, int count, String titulo, String status,
		...
		Pageable pages = new PageRequest(page, count);
		return this.ticketRepository.findByTituloIgnoreCaseContainingAndStatusAndPriorityAndUserIdOrderByDateDesc(titulo, status, priority, pages);
	}
	...
	@Override
	public Page<Ticket> findParametersAndAssignedUser(int page, int count, String titulo, String status,
